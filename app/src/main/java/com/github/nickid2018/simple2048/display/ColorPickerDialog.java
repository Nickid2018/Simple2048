...
public class ColorPickerDialog extends Dialog {
    ...
    private class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            canvas.translate(mWidth / 2.0f, mHeight / 2.0f - 50);
            ...
            Shader rectShader = new LinearGradient(rectLeft, 0, rectRight, 0, mRectColors, null, Shader.TileMode.MIRROR);
        ...
        public boolean onTouchEvent(MotionEvent event) {
            float x = event.getX() - mWidth / 2.0f;
            float y = event.getY() - mHeight / 2.0f + 50;
